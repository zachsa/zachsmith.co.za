      ...
      <Grid>
        <Cell phoneSize={6} tabletSize={2} size={2}>
          <div style={{textAlign: "left"}}>
            <p>Hi, I'm Zach!</p>
            <p><a className="link" target="_blank" href="https://github.com/zachsa">Github</a></p>
            <p><a className="link" target="_blank" href="https://www.linkedin.com/in/zachsmithsouthafrica/">LinkedIn</a></p>
            <p><a className="link" target="_blank" href="https://stackoverflow.com/users/3114742">StackOverflow</a></p>
            <p><a className="link" target="_blank" href="https://open.spotify.com/album/0HCL1uiaVM9tSyJzhpZIq7">Album</a> ← Click this!!</p>
          </div>
        </Cell>
